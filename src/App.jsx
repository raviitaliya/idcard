  ...
  return (
    <div>
      ...
      <div className='w-[1011px] h-[637.5px] relative'>
        <img src="/Group 39.svg" alt="" className='absolute opacity-30' />
        <div>
          <div className='w-[884.3px] h-[92px] absolute  top-[33px] left-1/2 transform -translate-x-1/2'>
            <img src="/Group 40.svg" alt="" className=' absolute  z-50' />
          </div>
          <div>
            <img src="/Group (3).svg" alt="" className='absolute top-[197px] left-[392px]' />
          </div>
          <div>
            <img src="/Rectangle.svg" alt="" className='absolute top-[225px] left-[66px] z-10' />
            <img src="/mem_dots_arrow.svg" alt="" className='absolute top-[375px] left-[22px]' />
            ...
            <img src="/Group (2).svg" alt="" className='absolute top-[245px] left-[777.5px] z-20' />
          </div>
        ...
        <img src="/Group 38.svg" alt="" className='absolute right-0 opacity-30 z-0' />
      </div>
      ...
      <div className='w-[1011px] h-[637.5px] mt-7 relative'>
        ...
        <div>
          ...
          <div>
            <img src="/Group 25.svg" alt="" className='absolute top-[312px] left-[389px]' />
          </div>
        ...
        <img src="/Group 38.svg" alt="" className='absolute right-0 opacity-30' />
      </div>
    </div>
  )
}
